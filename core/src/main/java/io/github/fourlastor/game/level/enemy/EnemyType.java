...
public enum EnemyType {
    ...
    ANGRY_PINEAPPLE_0(0.5f, 30, 0.7f, Settings.PLAYER_SPEED * 0.1f, "angry-pineapple-0", 10, RewardType.XP_M, RewardType.XP_S),
    ANGRY_PINEAPPLE_1(0.5f, 30, 0.7f, Settings.PLAYER_SPEED * 0.1f, "angry-pineapple-1", 10, RewardType.XP_M, RewardType.XP_S),
    ANGRY_PINEAPPLE_2(0.5f, 30, 0.7f, Settings.PLAYER_SPEED * 0.1f, "angry-pineapple-2", 10, RewardType.XP_M, RewardType.XP_S),
    ...
    EnemyType(float size, int maxHealth, float speed, float frameDuration, String animationPath, float damage, RewardType... rewards) {
        this.size = size;
