...
public enum EnemyType {
    ...
    PIGEON_1(0.3f, 15, 0.25f, 0.15f, "pigeon-1", 7, "pigeon 0.wav", RewardType.XP_S),
    SATCHMO(0.5f, 30, 0.2f, 0.15f, "satchmo", 15, "satchmo.wav", RewardType.XP_S),
    SPARK(0.5f, 20, 0.32f, 0.15f, "spark", 10, "325462__insanity54__laugh001.ogg", RewardType.XP_S),
    ANGRY_PINEAPPLE_0(
            0.5f, 50, 0.1f, 0.15f, "angry-pineapple-0", 10, "fruit squish.wav", RewardType.XP_M, RewardType.XP_S),
    ANGRY_PINEAPPLE_1(
            0.5f, 40, 0.2f, 0.15f, "angry-pineapple-1", 10, "fruit squish.wav", RewardType.XP_M, RewardType.XP_S),
    ANGRY_PINEAPPLE_2(
            0.5f, 30, 0.3f, 0.15f, "angry-pineapple-2", 10, "fruit squish.wav", RewardType.XP_M, RewardType.XP_S),
