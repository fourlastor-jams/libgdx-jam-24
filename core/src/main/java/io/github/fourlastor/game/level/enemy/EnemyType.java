...
public enum EnemyType {
    ...
    DRAGON_QUEEN(0.5f, 1_300, 0.22f, 0.2f, "dragon-queen", 25, "dragonQueen0.wav", RewardType.XP_M, RewardType.XP_M, RewardType.XP_S),
    RAELEUS(0.5f, 1_620, 0.32f, 0.2f, "raeleus", 30, "horse.wav", RewardType.XP_M, RewardType.XP_M, RewardType.XP_S),
    HYDROLIEN(0.5f, 2_900, 0.3f, 0.2f, "hydrolien", 40, "fox bark.wav", RewardType.XP_M),
    LAVA_EATER(
            0.5f,
            2_350,
            0.3f,
