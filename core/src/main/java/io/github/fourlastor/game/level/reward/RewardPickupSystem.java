...
public class RewardPickupSystem extends EntitySystem {
    ...
    private static final Family FAMILY = Family.all(Reward.class, Reward.PickUp.class).get();
    ...
    @Inject
    public RewardPickupSystem(ComponentMapper<Player> players, ComponentMapper<Reward> rewards, ComponentMapper<Reward.PickUp> pickups) {
